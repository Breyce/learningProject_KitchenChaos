...
public class KitchenGameMultiplayer : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerName = PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAME_MULTIPLAYER, "PlayerName_" + UnityEngine.Random.Range(100, 1000));
    ...
    private void Start()
    {
        if (!playMultiplayer)
        {
            KitchenGameLobby.Instance.SinglePlayer();
    ...
    {
        Debug.Log("here StartHost");
        NetworkManager.Singleton.ConnectionApprovalCallback += NetworkManager_ConnectionApprovalCallBack;
        NetworkManager.Singleton.OnClientConnectedCallback += NetworkManager_OnClientConnectedCallback;
        NetworkManager.Singleton.OnClientDisconnectCallback += NetorkManager_Server_OnClientDisconnectCallback;

        NetworkManager.Singleton.StartHost();
    }

    private void NetorkManager_Server_OnClientDisconnectCallback(ulong clientId)
    {
    ...
    public void KickPlayer(ulong clientId)
    {
        ...
        NetorkManager_Server_OnClientDisconnectCallback(clientId);
    }
}
